...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    {
        { "cinematic",      SEC_ANIM,      false, &ChatHandler::HandleDebugPlayCinematicCommand,       "", NULL },
        { "movie",          SEC_ANIM,      false, &ChatHandler::HandleDebugPlayMovieCommand,           "", NULL },
        { "sound",          SEC_ANIM,      false, &ChatHandler::HandleDebugPlaySoundCommand,           "", NULL },
        { NULL,             0,                  false, NULL,                                                "", NULL }
    };
    ...
    static ChatCommand debugCommandTable[] =
    {
        ...
        { "play",           SEC_ANIM,      false, NULL,                                                "", debugPlayCommandTable },
    ...
    {
        { "chat",           SEC_ANIM,      false, &ChatHandler::HandleGMChatCommand,              "", NULL },
        ...
        { "visible",        SEC_ANIM,      false, &ChatHandler::HandleGMVisibleCommand,           "", NULL },
        { "",               SEC_ANIM,      false, &ChatHandler::HandleGMCommand,                  "", NULL },
        { NULL,             0,                  false, NULL,                                           "", NULL }
    };

    static ChatCommand goCommandTable[] =
    {
        { "creature",       SEC_ANIM,      false, &ChatHandler::HandleGoCreatureCommand,          "", NULL },
        { "graveyard",      SEC_ANIM,      false, &ChatHandler::HandleGoGraveyardCommand,         "", NULL },
        { "grid",           SEC_ANIM,      false, &ChatHandler::HandleGoGridCommand,              "", NULL },
        { "object",         SEC_ANIM,      false, &ChatHandler::HandleGoObjectCommand,            "", NULL },
        { "taxinode",       SEC_ANIM,      false, &ChatHandler::HandleGoTaxinodeCommand,          "", NULL },
        { "trigger",        SEC_ANIM,      false, &ChatHandler::HandleGoTriggerCommand,           "", NULL },
        { "zonexy",         SEC_ANIM,      false, &ChatHandler::HandleGoZoneXYCommand,            "", NULL },
        { "xy",             SEC_ANIM,      false, &ChatHandler::HandleGoXYCommand,                "", NULL },
        { "xyz",            SEC_ANIM,      false, &ChatHandler::HandleGoXYZCommand,               "", NULL },
        { "",               SEC_ANIM,      false, &ChatHandler::HandleGoCommand,                  "", NULL },
        { NULL,             0,                  false, NULL,                                           "", NULL }
    };
    ...
    static ChatCommand learnCommandTable[] =
    {
        ...
        { "all_default",    SEC_ANIM,      false, &ChatHandler::HandleLearnAllDefaultCommand,     "", NULL },
        { "all_lang",       SEC_ANIM,      false, &ChatHandler::HandleLearnAllLangCommand,        "", NULL },
    ...
    static ChatCommand lookupCommandTable[] =
    {
        ...
        { "area",           SEC_ANIM,      true,  &ChatHandler::HandleLookupAreaCommand,          "", NULL },
        ...
        { "tele",           SEC_ANIM,      true,  &ChatHandler::HandleLookupTeleCommand,          "", NULL },
    ...
    {
        { "hp",             SEC_ANIM,      false, &ChatHandler::HandleModifyHPCommand,            "", NULL },
        { "mana",           SEC_ANIM,      false, &ChatHandler::HandleModifyManaCommand,          "", NULL },
        { "rage",           SEC_ANIM,      false, &ChatHandler::HandleModifyRageCommand,          "", NULL },
        { "runicpower",     SEC_ANIM,      false, &ChatHandler::HandleModifyRunicPowerCommand,    "", NULL },
        { "energy",         SEC_ANIM,      false, &ChatHandler::HandleModifyEnergyCommand,        "", NULL },
        { "money",          SEC_ANIM,      false, &ChatHandler::HandleModifyMoneyCommand,         "", NULL },
        { "speed",          SEC_ANIM,      false, &ChatHandler::HandleModifySpeedCommand,         "", NULL },
        { "swim",           SEC_ANIM,      false, &ChatHandler::HandleModifySwimCommand,          "", NULL },
        { "scale",          SEC_ANIM,      false, &ChatHandler::HandleModifyScaleCommand,         "", NULL },
        { "bwalk",          SEC_ANIM,      false, &ChatHandler::HandleModifyBWalkCommand,         "", NULL },
        { "fly",            SEC_ANIM,      false, &ChatHandler::HandleModifyFlyCommand,           "", NULL },
        { "aspeed",         SEC_ANIM,      false, &ChatHandler::HandleModifyASpeedCommand,        "", NULL },
        { "faction",        SEC_ANIM,      false, &ChatHandler::HandleModifyFactionCommand,       "", NULL },
        { "tp",             SEC_ANIM,      false, &ChatHandler::HandleModifyTalentCommand,        "", NULL },
        { "mount",          SEC_ANIM,      false, &ChatHandler::HandleModifyMountCommand,         "", NULL },
        { "honor",          SEC_ANIM,      false, &ChatHandler::HandleModifyHonorCommand,         "", NULL },
        { "rep",            SEC_GAMEMASTER,     false, &ChatHandler::HandleModifyRepCommand,           "", NULL },
        { "arena",          SEC_ANIM,      false, &ChatHandler::HandleModifyArenaCommand,         "", NULL },
        { "drunk",          SEC_ANIM,      false, &ChatHandler::HandleModifyDrunkCommand,         "", NULL },
    ...
    static ChatCommand npcCommandTable[] =
    {
        ...
        { "say",            SEC_ANIM,      false, &ChatHandler::HandleNpcSayCommand,              "", NULL },
        { "textemote",      SEC_ANIM,      false, &ChatHandler::HandleNpcTextEmoteCommand,        "", NULL },
        { "unfollow",       SEC_GAMEMASTER,     false, &ChatHandler::HandleNpcUnFollowCommand,         "", NULL },
        { "whisper",        SEC_ANIM,      false, &ChatHandler::HandleNpcWhisperCommand,          "", NULL },
        { "yell",           SEC_ANIM,      false, &ChatHandler::HandleNpcYellCommand,             "", NULL },
    ...
    static ChatCommand sendCommandTable[] =
    {
        ...
        { "mail",           SEC_ANIM,      true,  &ChatHandler::HandleSendMailCommand,            "", NULL },
    ...
    static ChatCommand teleCommandTable[] =
    {
        ...
        { "name",           SEC_ANIM,      true,  &ChatHandler::HandleTeleNameCommand,            "", NULL },
        { "group",          SEC_ANIM,      false, &ChatHandler::HandleTeleGroupCommand,           "", NULL },
        { "",               SEC_ANIM,      false, &ChatHandler::HandleTeleCommand,                "", NULL },
        { NULL,             0,                  false, NULL,                                           "", NULL }
    };
    ...
    static ChatCommand confrerieCommandTable[] =
    {
        ...
        { "itemnumber",     SEC_ANIM,           false, &ChatHandler::HandleConfrerieItemNumberCommand, "", NULL },
        { NULL,             0,                  false, NULL,                                           "", NULL }
    };
    ...
    static ChatCommand commandTable[] =
    {
        ...
        { "debug",          SEC_ANIM,      true,  NULL,                                           "", debugCommandTable    },
        { "event",          SEC_GAMEMASTER,     false, NULL,                                           "", eventCommandTable    },
        { "gm",             SEC_PLAYER,         true,  NULL,                                           "", gmCommandTable       },
        { "honor",          SEC_GAMEMASTER,     false, NULL,                                           "", honorCommandTable    },
        { "go",             SEC_ANIM,      false, NULL,                                           "", goCommandTable       },
        { "gobject",        SEC_GAMEMASTER,     false, NULL,                                           "", gobjectCommandTable  },
        { "guild",          SEC_GAMEMASTER,     true,  NULL,                                           "", guildCommandTable    },
        { "instance",       SEC_ADMINISTRATOR,  true,  NULL,                                           "", instanceCommandTable },
        { "learn",          SEC_ANIM,      false, NULL,                                           "", learnCommandTable    },
        { "list",           SEC_ADMINISTRATOR,  true,  NULL,                                           "", listCommandTable     },
        { "lookup",         SEC_ANIM,      true,  NULL,                                           "", lookupCommandTable   },
        { "modify",         SEC_ANIM,      false, NULL,                                           "", modifyCommandTable   },
        { "npc",            SEC_ANIM,      false, NULL,                                           "", npcCommandTable      },
        { "pdump",          SEC_ADMINISTRATOR,  true,  NULL,                                           "", pdumpCommandTable    },
        { "quest",          SEC_ADMINISTRATOR,  false, NULL,                                           "", questCommandTable    },
        { "reload",         SEC_ADMINISTRATOR,  true,  NULL,                                           "", reloadCommandTable   },
        { "reset",          SEC_ADMINISTRATOR,  true,  NULL,                                           "", resetCommandTable    },
        { "server",         SEC_PLAYER,         true,  NULL,                                           "", serverCommandTable   },
        { "tele",           SEC_ANIM,      true,  NULL,                                           "", teleCommandTable     },
        { "titles",         SEC_GAMEMASTER,     false, NULL,                                           "", titlesCommandTable   },
        { "trigger",        SEC_GAMEMASTER,     false, NULL,                                           "", triggerCommandTable  },
        { "wp",             SEC_GAMEMASTER,     false, NULL,                                           "", wpCommandTable       },
        { "confrerie",      SEC_PLAYER,       false, NULL,                                           "", confrerieCommandTable},

        { "aura",           SEC_ADMINISTRATOR,  false, &ChatHandler::HandleAuraCommand,                "", NULL },
        { "unaura",         SEC_ADMINISTRATOR,  false, &ChatHandler::HandleUnAuraCommand,              "", NULL },
        { "announce",       SEC_ANIM,      true,  &ChatHandler::HandleAnnounceCommand,            "", NULL },
        { "notify",         SEC_ANIM,      true,  &ChatHandler::HandleNotifyCommand,              "", NULL },
        { "goname",         SEC_ANIM,      false, &ChatHandler::HandleGonameCommand,              "", NULL },
        { "namego",         SEC_ANIM,      false, &ChatHandler::HandleNamegoCommand,              "", NULL },
        { "groupgo",        SEC_ANIM,      false, &ChatHandler::HandleGroupgoCommand,             "", NULL },
        ...
        { "gps",            SEC_ANIM,      false, &ChatHandler::HandleGPSCommand,                 "", NULL },
        ...
        { "recall",         SEC_ANIM,      false, &ChatHandler::HandleRecallCommand,              "", NULL },
        { "save",           SEC_PLAYER,         false, &ChatHandler::HandleSaveCommand,                "", NULL },
        { "saveall",        SEC_ANIM,      true,  &ChatHandler::HandleSaveAllCommand,             "", NULL },
        ...
        { "taxicheat",      SEC_ANIM,      false, &ChatHandler::HandleTaxiCheatCommand,           "", NULL },
        ...
        { "whispers",       SEC_ANIM,      false, &ChatHandler::HandleWhispersCommand,            "", NULL },
        ...
        { "send",           SEC_ANIM,      true,  NULL,                                           "", sendCommandTable     },
        { "loadscripts",    SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleLoadScriptsCommand,         "", NULL },
        { "mute",           SEC_ANIM,      true,  &ChatHandler::HandleMuteCommand,                "", NULL },
        { "unmute",         SEC_ANIM,      true,  &ChatHandler::HandleUnmuteCommand,              "", NULL },
